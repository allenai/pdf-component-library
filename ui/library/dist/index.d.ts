...
declare module 'pdf-components/src/components/PageWrapper' {
    import * as React from 'react';
    import { RenderFunction } from 'react-pdf/dist/Page';
    import { HighlightOverlay } from 'pdf-components/src/components/HighlightOverlay';
    import { Overlay } from 'pdf-components/src/components/Overlay';
    /**
