...
import { PDODCitationPopoverSearchField } from './PDODCitationPopoverSearchField';
...
export const PDODCitationPopover: React.FunctionComponent<Props> = ({
  citation,
  parentRef,
}: Props) => {
  ...
  function renderPaperSummary(paper: CitationPaper): React.ReactNode {
    ...
    return (
      <div className="reader__popover__citation">
        ...
        <p>
          <PDODCitationPopoverSearchField />
        </p>
      </div>
    );
  }
