...
export function scaleRawBoundingBoxWithContext(box: BoundingBoxType, documentContext: IDocumentContext, transformContext: ITransformContext): BoundingBoxType {
  const { pageSize } = documentContext;
  ...
  const transformedSize = computeStyleWithContext(scaledToPageSize.top, scaledToPageSize.left, scaledToPageSize.height, scaledToPageSize.width, documentContext, transformContext);
  return {
    page: box.page,
    ...transformedSize,
  };
