...
describe('<ContextProvider/>', () => {
    ...
    describe('<PageSizeContext.Provider/>', () => {
        let _setPageSize: Function;
        let _setRotation: Function;
        let _setScale: Function;
    ...
    describe('<UIContext.Provider/>', () => {
        let _setErrorMessage: Function;
        let _setIsDrawerOpen: Function;
        let _setIsLoading: Function;
        let _setIsShowingHighlightOverlay: Function;
        let _setNumPages: Function;
        ...
        before(() => {
            wrapper = mount(
                <ContextProvider>
                    <UIContext.Consumer>
                        {(args: UIContextData) => {
                            const { drawerContainerClass, errorMessage, isDrawerOpen, isLoading,
                                isShowingHighlightOverlay, numPages, setErrorMessage, setIsDrawerOpen,
                                setIsLoading, setIsShowingHighlightOverlay, setNumPages } = args;
                            ...
                            return <div>
                                ...
                                <div className="isShowingHighlightOverlay">{isShowingHighlightOverlay.toString()}</div>
