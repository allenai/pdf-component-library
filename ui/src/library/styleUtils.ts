...
export function computeBoundingBoxStyle(boundingBoxSize: Size, pageDimensions: Dimensions, rotation: PageRotation, scale: number) {
...
export function computePageStyle(pageDimensions: Dimensions, rotation: PageRotation, scale: number) {
    return {
...
export function getPageHeight(pageDimensions: Dimensions, rotation: PageRotation) {
...
export function getPageWidth(pageDimensions: Dimensions, rotation: PageRotation) {
