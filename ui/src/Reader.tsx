...
export const Reader: React.FunctionComponent<RouteComponentProps> = () => {
  ...
  // Creates a map from pageIndex to Annotations for that page.
  // Currently only Citations are implemented.
  function initAnnotations() {
    ...
    rawEntities.map((entity) => {
      ...
      if (entity.type === ENTITY_TYPE.CITATION && entity.attributes.paper_id) {
        ...
        boxes.map((box) => {
          if (typeof box.page === 'number') {
            ...
            const scaledBox = scaleRawBoundingBoxWithContext(box, documentContext, transformContext);
